      ...
      >
        ...
        <div className="relative z-[1]">
          <p className="mx-auto mb-8 max-w-xl text-center font-sans text-[clamp(0.95rem,2vw,1.1rem)] leading-relaxed text-primary-200/90">
            Quelques réalisations mises en avant : aperçu visuel, résumé du contexte, puis
            fiche détaillée sur chaque projet.
          </p>
          <motion.div
            ...
            {projects.map((img) => (
              ...
              >
                <header className="flex h-20 w-full shrink-0 items-center gap-3 border-b border-primary-200/10">
                  <img
                    className="h-12 w-12 shrink-0 rounded-lg object-cover shadow-[0_4px_12px_rgba(0,0,0,0.35)]"
