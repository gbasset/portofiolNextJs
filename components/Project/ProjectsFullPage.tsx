...
interface ProjectsFullPageProps {
  embedded?: boolean;
}

export default function ProjectsFullPage({ embedded = false }: ProjectsFullPageProps) {
  ...
  return (
    <div
      id={embedded ? 'projects-showcase' : undefined}
      className={embedded ? 'relative mx-auto w-[92%] max-w-6xl pb-16' : 'relative'}
    >
      {embedded && (
        <div className="mb-8 text-center">
          ...
          <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] uppercase tracking-wide text-primary-200">
